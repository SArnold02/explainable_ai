...
class_names = scipy.io.loadmat('./data/stanford_cars/devkit/cars_meta.mat')
...
mat = scipy.io.loadmat('./data/stanford_cars/devkit/cars_train_annos.mat')
...
mat = scipy.io.loadmat('./data/stanford_cars/cars_test_annos_withlabels.mat')
# print(mat['annotations'])
testing_class = mat['annotations']['class']
testing_fname = mat['annotations']['fname']

training_source = './data/stanford_cars/cars_train/' # specify source training image path
...
testing_source = './data/stanford_cars/cars_test/' # specify source testing image path
